...
with st.form("autobiography_form"):
    ...
    story = st.text_area("展現韌性/特質的小故事 (一句話)", placeholder="例如：半工半讀完成學業，並曾與母親合開早餐店，這段經歷培養了我解決問題的行動力。")
...
if submitted:
    ...
    if not name or not highest_school or not target_school or not target_dept:
        ...
        lines.append(f"我的處事觀念是「不做不會怎樣，做了很不一樣」，並始終以「事情要做到最好」要求自己。在成長過程中，我因 **{story}**，培養出強大的**抗壓性與執行力**。這段經歷使我具備獨立思考的能力，並能以樂觀積極的態度面對學術研究上的挑戰。")
        lines.append("")
